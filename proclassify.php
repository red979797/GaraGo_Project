...
<nav aria-label="Page navigation example">
  <ul class="pagination">                           
    <li class="page-item"><a class="page-link" href="proclassify.php?search=<?php echo $_GET["search"];?>&a=<?php echo $_GET["a"];?>&b=<?php echo $_GET["b"];?>&location=<?php echo $_GET["location"];?>&page=1'">First</a></li>

    <?php
      if($prev_page > 1) {
        echo '<li class="page-item"><a class="page-link" href="proclassify.php?search='.$_GET["search"].'&a='.$_GET["a"].'&b='.$_GET["b"].'&location='.$_GET["location"].'&page='.$prev_page.'">Prev</a></li>';
      }
      ...
      for($i = $start_page; $i <= $end_page; $i++) {
        if($i == $page) {
          ...
          echo '<li class="page-item"><a class="page-link" href="proclassify.php?search='.$_GET["search"].'&a='.$_GET["a"].'&b='.$_GET["b"].'&location='.$_GET["location"].'&page='.$i.'">'.$i.'</a></li>';
      ...
      if($next_page <= $total_page) {
        echo '<li class="page-item"><a class="page-link" href="proclassify.php?search='.$_GET["search"].'&a='.$_GET["a"].'&b='.$_GET["b"].'&location='.$_GET["location"].'&page='.$next_page.'">Next</a></li>';
      }

      if($page < $total_page) {
        echo '<li class="page-item"><a class="page-link" href="proclassify.php?search='.$_GET["search"].'&a='.$_GET["a"].'&b='.$_GET["b"].'&location='.$_GET["location"].'&page='.$total_page.'">Last</a></li>';
      }
    ?>
    </ul>
</nav>
